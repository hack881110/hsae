...
//                txt.setTag(xy);
                txt.setTag(R.id.tag_first,xy);
                txt.setTag(R.id.tag_second, keyword);
            ...
            int yItem)
    {
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            int[] iXY = (int[])txt.getTag(R.id.tag_first);
        //    int flag = (int)txt.getTag(R.id.tag_second);
            ...
            {
                int[] kXY = (int[]) listTxt.get(k).getTag(R.id.tag_first);
    ...
    private void sortXYList(LinkedList<RippleView> listTxt, int endIdx)
    {
        for (int i = 0; i < endIdx; i++)
        {
            ...
            {
                if (((int[]) listTxt.get(k).getTag(R.id.tag_first))[IDX_DIS_Y] < ((int[]) listTxt
                        .get(i).getTag(R.id.tag_first))[IDX_DIS_Y])
                {
